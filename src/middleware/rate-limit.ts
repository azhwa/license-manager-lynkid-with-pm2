...
type RateLimitOptions = { scope: string; maxRequests: number; windowSeconds: number };
...
export const checkRateLimit = createRateLimit({ scope: 'license-check', maxRequests: 20, windowSeconds: 60 });
